...
@Processor(QUEUE.RESEND_CONFIRMATION_ACCOUNT)
export class ResendConfirmationAccountJob {
  private readonly logger = new Logger(ResendConfirmationAccountJob.name);

  constructor(private readonly mailService: MailService) {}

  @Process(QUEUE.RESEND_CONFIRMATION_ACCOUNT)
